...
set(_exported_interfaces "export_opencv_cam_node;export_subscriber_node")

# include all exported interfaces
if(NOT _exported_interfaces STREQUAL "")
  foreach(_interface ${_exported_interfaces})
    set(_export_file "${opencv_cam_DIR}/${_interface}Export.cmake")
    ...
    list(APPEND opencv_cam_INTERFACES ${_targets})
  endforeach()
endif()
